    ...
    <div class="humberger__menu__wrapper" >
        ...
        <nav class="humberger__menu__nav mobile-menu">
            <ul>
                ...
                <li><a href="../shopping/index.php?shop=<?php echo $id_shop ?>">Shop</a></li>
                <li><a href="#">Pages</a>
                ...
                <div class="col-lg-6">
                    <nav class="header__menu">
                        <ul>
                            ...
                            <?php
                                if(isset($_GET["shop"])){
                                    $link = "../shopping/index_2.php?shop="."$id_shop"."";
                                }
                                else{
                                    $link = "../shopping/index.php";
                                }
                            ?>
                            <li><a href=<?php echo $link;?>>Shop</a></li>
                            <li><a href="#">Pages</a>
                                <ul class="header__menu__dropdown">
                                    <li><a href="./shop-details.html">Shop Details</a></li>
                                    <li><a href="./shoping-cart.html">Shoping Cart</a></li>
                    ...
                    <div class="hero__search">
                        <div class="hero__search__form">
                            <form action="#">
                                ...
                                <button type="submit" class="site-btn" style= "background: #FF99CC">SEARCH</button>
                            </form>
                        </div>
                    </div>
